...
public class EverClass {
     ...
     */
    public EverClass(String token) throws Exception {
     ...
     */
    public void updateNoteTag() throws Exception {
    ...
    public static Data readFileAsData(String fileName) throws Exception {
        String filePath = new File(EverClass.class.getResource(
                EverClass.class.getCanonicalName() + ".class").getPath()).getParent()
